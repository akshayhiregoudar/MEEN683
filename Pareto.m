...
function [x,fval,exitflag,output,pop,scores]= min_cost()
    ...
    for i = 1:4
        ...
        options = optimoptions('gamultiobj','PlotFcn',@gaplotpareto,'ConstraintTolerance',1e-10,'FunctionTolerance',1e-20,...
            'CrossoverFraction',0.8,...
            'PopulationSize',200,'PenaltyFactor',1000);
             
[x,fval,exitflag,output,pop,scores]=gamultiobj(@Cost,6,A,b,[],[],lb,ub,[],[],options);
        end
    end
    function f= Cost(x)
